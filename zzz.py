...
async def main():
    async with async_playwright() as p:
        browser = await p.chromium.launch(headless=False)   # remember if you set headless to true then enable(uncomment) the http headers below
